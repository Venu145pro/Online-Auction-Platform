...
const SECRET_KEY = 'venuauction';

// Connect to MongoDB
mongoose.connect('mongodb+srv://venulucky951:venuauction@cluster0.z6kl5.mongodb.net/');
...
app.post('/signin', async (req, res) => {
  ...
  if (user) {
    const token = jwt.sign({ userId: user._id, username }, SECRET_KEY, { expiresIn: '2h' });//this token helps the user to remain signed in for an 1hour
